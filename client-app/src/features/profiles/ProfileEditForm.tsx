...
export const ProfileEditForm = observer(({ setEditMode }: { setEditMode: (editMode: boolean) => void }) => {
        ...
        >
            {({ isSubmitting, isValid, dirty }) => (
                <Form className='ui form'>
                    <InputControl placeholder='Display Name'
                        name='displayName' />
                    <TexTAreaControl rows={3} placeholder='Add your bio'
                        name='bio' />
                    <Button
                        positive
                        type='submit'
